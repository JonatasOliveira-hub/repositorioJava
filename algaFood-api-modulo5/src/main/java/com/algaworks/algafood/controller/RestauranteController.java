...
//	public ResponseEntity<?> atulizarRestaurante(@PathVariable Long restauranteId, @RequestBody Restaurante restaurante) {
//		try {
//			final Restaurante restauranteAtualizado = serviceRestaurante.atualizar(restauranteId, restaurante);
//
	...
	public ResponseEntity<?> atualizar(@PathVariable Long restauranteId,
		...
		try {
			...
			if (restauranteAtual != null) {
				...
				restauranteAtual = serviceRestaurante.salvar(restauranteAtual);
